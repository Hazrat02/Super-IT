...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function setRequiredInfo(array $info)
    {
        ...
        $this->data['cus_id'] = $info['cus_id']; // string (50)	Mandatory - Mention the product category. It is a open field. Example - clothing,shoes,watches,gift,healthcare, jewellery,top up,toys,baby care,pants,laptop,donation,etc
