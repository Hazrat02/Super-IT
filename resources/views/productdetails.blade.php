...
@section('maincontent')
    ...
    <body>
                                                ...
                                                <div class="swiper-wrapper row cols-1 gutter-no">
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="{{asset('userstyle')}}/assets/images/products/default/1-800x900.jpg"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="{{asset('userstyle')}}/assets/images/products/default/2-800x900.jpg"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="{{asset('userstyle')}}/assets/images/products/default/3-800x900.jpg"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="{{asset('userstyle')}}/assets/images/products/default/4-800x900.jpg"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="{{asset('userstyle')}}/assets/images/products/default/6-800x900.jpg"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="{{asset('userstyle')}}/assets/images/products/default/5-800x900.jpg"
                                                                    ...
                                                                    <div class="comment-content">
                                                                        ...
                                                                        <div class="comment-action">
                                                                            ...
                                                                            <a href="#"
                                                                                class="btn btn-dark btn-link btn-underline sm btn-icon-left font-weight-normal text-capitalize">
                                                                                <i
                                                                                    class="far fa-thumbs-down"></i>Unhelpful
                                                                                (0)
                                                                            </a>
                                                                            <div class="review-image">
                                                                                <a href="#">
                                    ...
                                    'breakpoints': {
                                        ...
                                        <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                            <div class="swiper-slide product">
                                                ...
                                                <div class="product-details">
                                                    <h4 class="product-name"><a href="product-default.html">Drone</a>
                                                    </h4>
                                                    <div class="ratings-container">
                                                        <div class="ratings-full">
                                                            <span class="ratings" style="width: 100%;"></span>
        ...
        <a id="scroll-top" class="scroll-top" href="#top" title="Top" role="button"> <i
                class="w-icon-angle-up"></i> <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 70 70">
