                ...
                <div class="row g-0 vh-lg-100">
                    <div  class="col-lg-7 pt-5 pt-lg-10">
                        <div class="pe-lg-5">
                            ...
                            <form action="{{route('order.information')}}" method="POST" class="mt-5">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="Firstname" type="text" class="form-control" id="firstNameBilling" placeholder=""
                                                value="" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="Lastname" type="text" class="form-control" id="lastNameBilling" placeholder=""
                                                value="" required="">
                                        </div>
                                    </div>
                                ...
                                <div class="pt-5 mt-5 pb-5 border-top d-flex justify-content-md-end align-items-center">
                                    <input type="submit" value="Proceed to shipping" class="btn btn-dark w-100 w-md-auto"
                                       />
                                </div>
                            </form>
                        </div>
