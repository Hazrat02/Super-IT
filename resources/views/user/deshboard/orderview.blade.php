                    ...
                    <div class="row mb-2">
                        <div class="col-lg-7 pr-lg-4 mb-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div  class="select-box">
                                        <select disabled name="customar_country" class="form-control form-control-md">
                                            ...
                                            <option @if ($order->customar_name=='uk')
                                                selected="selected"
                                            @endif
                                             value="uk">United Kingdom (UK)</option>
                                            <option @if ($order->customar_country=='us')
                                                selected="selected"
                                            @endif value="us">United States</option>
                                            <option @if ($order->customar_country=='fr')
                                                selected="selected"
                                            @endif value="fr">France</option>
                                            <option @if ($order->customar_country=="aus")
                                                selected="selected"
                                            @endif value="aus">Australia</option>
                                            <option @if ($order->customar_country=='bangladesh')
                                                selected="selected"
                            ...
                            <div class="row gutter-sm">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" value="{{$order->customar_district}}" class="form-control form-control-md" name="customar_distric" required>
                                    </div>
                                    <div class="form-group">
                                        <label>ZIP *</label>
                                        <input disabled value="{{$order->zip}}" type="number" class="form-control form-control-md" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>Phone *</label>
                                        <input disabled value="{{$order->customar_number}}" type="number" class="form-control form-control-md" name="customar_number" required>
                                    </div>
                                    <div class="form-group">
                                        <label>village *</label>
                                        <input disabled value=" {{$order->customar_village}}" type="text" class="form-control form-control-md" name="customar_village" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="form-group mb-7">
                                ...
                                <input disabled value=" {{$order->customar_email}}" type="email" class="form-control form-control-md" >
                            </div>
                        ...
                        <div class="col-lg-5 mb-4 sticky-sidebar-wrapper mt-4">
                            <div class="order-summary-wrapper sticky-sidebar">
                                ...
                                <a href="{{route('order.delivery',['id'=>$order->id])}}" class="btn btn-dark btn-block btn-rounded">Deliveryed</a>
                                </div>
                            </div>
                        </div>
                    </div>
