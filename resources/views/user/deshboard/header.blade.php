<header  class="header">
    <div class="page-wrapper">
        ...
        <header class="header">
            ...
            box-shadow: 0px 0px 8px 1px #888888;" class="header-middle ">
                <div class="container">
                    <div class="header-left mr-md-4">
                        <a href="{#}" class="mobile-menu-toggle  w-icon-hamburger" aria-label="menu-toggle">
                        </a>
                        <a href="{{route('home')}}" class="logo ml-lg-0">
                            <img src="{{asset('img\20230109_014602.png')}}" alt="logo" width="144" height="45" />
                        </a>
    ...
    <a id="scroll-top" class="scroll-top" href="#top" title="Top" role="button"> <i
            ...
            <circle id="progress-indicator" fill="transparent" stroke="#000000" stroke-miterlimit="10"
                cx="35" cy="35" r="34" style="stroke-dasharray: 16.4198, 400;">
            </circle>
        </svg> </a>
    <!-- End of Scroll Top -->
